...
void gen_exception_push(HC_FILE, size_t label);
void gen_exception_pop(HC_FILE);
void gen_exception_throw(HC_FILE, reg_t* val, reg_t* msg);
void gen_exception_recup(HC_FILE);
